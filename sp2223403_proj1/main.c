...
void labelcopy(char* copy, char* label, char* OPeratoroperand, char* senevcolumn, FILE* fp);
	...
	int main(void) {
		...
		while (fgets(str, sizeof(str), fs) != NULL) {
			...
			char trimoperand[38] = "";
				...
				StringCopy(str, copy);
				labelcopy(copy, label, OPeratoroperand, senevcolumn, fp);
